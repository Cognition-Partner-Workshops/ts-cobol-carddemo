...
| S01-B1 | 2026-08-20 | S-01 analysis | B5 cross-program switch | XCTL from menus to 10 core route programs w/ CARDDEMO-COMMAREA | app/cbl/COMEN01C.cbl:185; app/cbl/COADM01C.cbl:146 | S-01 (+ all route streams) | Target routing: Angular nav + per-stream API; "not installed" until migrated | UNDECIDED | — |
| S01-B2 | 2026-08-20 | S-01 analysis | B5 availability probe | XCTL COPAUS0C guarded by INQUIRE PROGRAM | app/cbl/COMEN01C.cbl:148-159 | S-01, S-19 | Map to feature-flag/route availability | UNDECIDED | — |
| S01-B3 | 2026-08-20 | S-01 analysis | B5 inbound return routing | Route programs XCTL back via CDEMO-TO-PROGRAM | app/cbl/COMEN01C.cbl:202 | S-01 (+ all online) | Stable return route in menu shell | UNDECIDED | — |
| S01-B4 | 2026-08-20 | S-01 analysis | B4 data-access leaf | CICS READ USRSEC KSDS by user id; RESP 0/13/other | app/cbl/COSGN00C.cbl:211-219 | S-01, S-12 | VSAM, target-owned → EF Core repository, no SP; Postgres users table Phase 1 | UNDECIDED | — |
| S01-B5 | 2026-08-20 | S-01 analysis | B10 shared data contract | USRSEC written by S-12 + DUSRSECJ batch, read by S-01 | app/jcl/DUSRSECJ.jcl:62-64 | S-01, S-12 | Single-writer decision at S-12 migration; seed parity meanwhile | UNDECIDED | — |
| S01-B6 | 2026-08-20 | S-01 analysis | B10 shared data contract | CARDDEMO-COMMAREA copybook shared by all online programs | app/cpy/COCOM01Y.cpy:19 | all online | Session-state seam ported once by S-01; module property | UNDECIDED | — |
