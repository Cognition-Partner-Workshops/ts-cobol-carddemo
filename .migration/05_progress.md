...
| S-18 Branch export/import | BATCH | CBEXPORT/CBIMPORT | IN WAVE A — child running (docs PR #106) | 2026-09-16 | Baseline jobs structurally correct; S18-B1..B7 decided (B6 text-format deviation, B7 legacy CARDOUT gap no-carry); deltas: 132-col error layout, per-type stats; Flyway V250x |
