...
| S-14 Daily posting chain | BATCH | Control-M DAILY | IN WAVE A — child running (docs PR #111) | 2026-09-16 | S14-B1..B9 decided; owns wait-step tasklet seam (S-15/S-16 consume); RC=4 + 430B reject trailer contract; CA-7 SCHID 030 authoritative for posting (Control-M disagrees); Flyway V210x |
...
| S-17 Data read/verify jobs | BATCH | READ*.jcl | IN WAVE A — child running (docs PR #106) | 2026-09-16 | Greenfield batch (no baseline jobs); CA-7 SCHID=030 chain documented; S17-B1..B7 decided (B7 pad-to-LRECL proposed); DateEditService for COBDATFT; Flyway V240x |
