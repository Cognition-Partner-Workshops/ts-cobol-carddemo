...
public class TransactionViewMapperTests
{
    ...
    {
        // FR-S08-10
        var transaction = TransactionViewTestRepository.SampleTransaction();
    ...
    public void ShortText_IsNotPadded()
    {
        ...
        var detail = TransactionViewMapper.ToDetail(TransactionViewTestRepository.SampleTransaction());
