...
public class Customer {
    ...
    @Column(name = "pri_card_holder", length = 1)
    private String priCardHolder;
    ...
    public String getPriCardHolder() { return priCardHolder; }
    public void setPriCardHolder(String priCardHolder) { this.priCardHolder = priCardHolder; }
